...
class TestBase(unittest.TestCase):
    def test_create_item(self):
        ...
        for world_type in AutoWorldRegister.get_testable_world_types():
            ...
            for item_name in world_type.item_name_to_id:
                with self.subTest("Create Item", item_name=item_name, game_name=world_type.game):
    ...
    def test_items_in_datapackage(self):
        ...
        for world_type in AutoWorldRegister.get_testable_world_types():
            with self.subTest("Game", game=world_type.game):
                multiworld = setup_solo_multiworld(world_type)
    ...
    def test_itempool_not_modified(self):
        ...
        worlds_to_test = {world.game: world
                          for world in AutoWorldRegister.get_testable_world_types()
                          if world.game not in excluded_games}
