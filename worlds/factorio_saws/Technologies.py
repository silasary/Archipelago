...
all_items = pool.submit(load_json_data, "items")
...
def get_science_pack_pools() -> Dict[str, Set[str]]:
    ...
    exclusion_list_new: Set[str] = {
        ...
        "parameter-2", "parameter-3", "parameter-4", "parameter-5", "parameter-6", "parameter-7", "parameter-8", "parameter-9", "fluid-unknown" 
    }
    # automation
    ...
    early_pool: Set[str] = {
        ...
        'steel-plate', 'iron-stick', 'ammonia', 'gun-turret', 'engine-unit', 'pump', 'uranium-ore', 'grenade', 'rail', 'rail-signal', 'rail-chain-signal', 'small-lamp', 'constant-comb inator', 
    ...
    mid_pool: Set[str] = {
        ...
        'holmium-plate', 'holmium-solution', 'electrolyte', 'holmium-ore', 'lightning-rod', 'cliff-explosives', 'tungsten-carbide', 'tungsten-plate', 'railgun-ammo', 'tesla-ammo', 'spoilage', 'jelly', 
    ...
    late_pool: Set[str] = {
        ...
        'uranium-fuel-cell', 'assembling-machine-3', 'locomotive', 'express-splitter', 'heavy-armor', 'beacon', 'personal-roboport-equipment', 'roboport', 'space-platform-foundation', 'cargo-bay', 
        'asteroid-collector', 'crusher', 'thruster', 'biter-egg', 'capture-robot-rocket', 'stack-inserter', 'heating-tower', 'pentapod-egg', 'superconductor', 'supercapacitor', 'molten-copper', 'molten-iron', 
        'artillery-shell', 'carbon-fiber', 'fusion-power-cell', 'jellynut-seed', 'yumako-seed', 'artificial-jellynut-soil', 'artificial-yumako-soil'
    }
    # cryogenic space
    very_late_pool: Set[str] = {
        ...
        'turbo-underground-belt', 'toolbelt-equipment', 'captive-biter-spawner', 'lightning-collector', 'electromagnetic-plant', 'foundry', 'biochamber', 'agricultural-tower', 'recycler', 'turbo-transport-belt', 
    ...
    hard_pool: Set[str] = {
        ...
        'fusion-generator', 'fusion-reactor', 'foundation', 'cargo-landing-pad', 'space-platform-starter-pack'
    }
    ...
    for science_pack in Options.MaxSciencePack.get_ordered_science_packs():
        match science_pack:
            case 'automation-science-pack':
                science_pack_pools[science_pack] = sphere_0_pool
                science_pack_pools[science_pack] -= fluids
            case 'logistic-science-pack' | 'military-science-pack':
                science_pack_pools[science_pack] = early_pool
            case 'chemical-science-pack' | 'production-science-pack' | 'utility-science-pack':
                science_pack_pools[science_pack] = mid_pool
            case 'agricultural-science-pack' | 'electromagnetic-science-pack' | 'metallurgic-science-pack':
                science_pack_pools[science_pack] = late_pool
            case 'cryogenic-science-pack' | 'space-science-pack':
                science_pack_pools[science_pack] = very_late_pool
