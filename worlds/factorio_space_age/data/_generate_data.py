 ...
 * rocket_fuel
 * rocket_silo
 * space_platform (for carbon)
 * space_science_pack
traveling space:
 * > ...rocket_silo (for building a space platform at all)
 * > space_platform (for carbon)
 * > oil_processing (for checmical plant)
 * space_platform_thruster (for thruster, fuel, oxidizer)
 * gun_turret (optional)
reach aquilo orbit:
 * > ...travel space
 * > oil_processing (for chemical plant)
 * > sulfur_processing
 * explosives
 * rocketry
 * landfill
 * planet_discovery_gleba
 * yumako
 * agriculture OR fish_breeding (for nutrients for biochamber)
 * biochamber
 * carbon_fiber
 * rocket_turret
 * planet_discovery_aquilo
 ...
 * > ...carbon_fiber
 * holmium_processing
 * electromagnetic_plant (for superconductor)
 * quantum_processor
 * tungsten_carbide
 * tungsten_steel
 * railgun
...
# TODO: Unimplemented
# See also: https://github.com/silasary/Archipelago/blob/factorio_saws-0.8.4/worlds/factorio_saws/Technologies.py#L454
...
large_progressive_groups = {
    ...
    "progressive-mining": [
        RawTechnology.electric_mining_drill,
        RawTechnology.mining_productivity_1,
        RawTechnology.mining_productivity_2,
        RawTechnology.mining_productivity_3, # infinite
    ],
    "progressive-oil": [
        RawTechnology.oil_gathering,
        RawTechnology.oil_processing,
        RawTechnology.fluid_handling,
        RawTechnology.sulfur_processing,
        RawTechnology.chemical_science_pack,
        RawTechnology.advanced_oil_processing,
        RawTechnology.coal_liquefaction,
        RawTechnology.fluid_wagon,
    ],
    "progressive-production": [
        RawTechnology.steel_processing,
        RawTechnology.steel_axe,
        RawTechnology.advanced_material_processing,
        RawTechnology.advanced_material_processing_2,
        RawTechnology.production_science_pack,
        RawTechnology.effect_transmission,
        RawTechnology.steel_plate_productivity, # infinite
    ],

    "progressive-logistics": [
        RawTechnology.logistics,
        RawTechnology.logistic_science_pack,
        RawTechnology.logistics_2,
        RawTechnology.logistics_3,
        RawTechnology.turbo_transport_belt,
        RawTechnology.transport_belt_capacity_1,
        RawTechnology.transport_belt_capacity_2,
    ],
    "progressive-inserter": [
        RawTechnology.fast_inserter,
        RawTechnology.bulk_inserter,
        RawTechnology.inserter_capacity_bonus_1,
        RawTechnology.inserter_capacity_bonus_2,
        RawTechnology.inserter_capacity_bonus_3,
        RawTechnology.stack_inserter,
        RawTechnology.inserter_capacity_bonus_4,
        RawTechnology.inserter_capacity_bonus_5,
        RawTechnology.inserter_capacity_bonus_6,
        RawTechnology.inserter_capacity_bonus_7,
    ],
    "progressive-circuit": [
        RawTechnology.plastics,
        RawTechnology.advanced_circuit,
        RawTechnology.processing_unit,
        RawTechnology.utility_science_pack,
        RawTechnology.circuit_network,
        RawTechnology.carbon_fiber,
        RawTechnology.quantum_processor,
        RawTechnology.advanced_combinators,
        RawTechnology.processing_unit_productivity, # infinite
    ],

    "progressive-robotics": [
        RawTechnology.engine,
        RawTechnology.lubricant,
        RawTechnology.electric_engine,
        RawTechnology.battery,
        RawTechnology.robotics,
        RawTechnology.construction_robotics,
        RawTechnology.worker_robots_speed_1,
        RawTechnology.worker_robots_speed_2,
        RawTechnology.worker_robots_speed_3,
        RawTechnology.worker_robots_speed_4,
        RawTechnology.worker_robots_speed_5,
        RawTechnology.worker_robots_speed_6,
        RawTechnology.worker_robots_speed_7, # infinite
    ],
    "progressive-logistic-robotics": [
        RawTechnology.logistic_robotics,
        RawTechnology.logistic_system,
        RawTechnology.worker_robots_storage_1,
        RawTechnology.worker_robots_storage_2,
        RawTechnology.worker_robots_storage_3,
    ],
    "progressive-train-network": [
        RawTechnology.railway,
        RawTechnology.automated_rail_transportation,
        RawTechnology.elevated_rail,
        RawTechnology.rail_support_foundations,
        RawTechnology.braking_force_1,
        RawTechnology.braking_force_2,
        RawTechnology.braking_force_3,
        RawTechnology.braking_force_4,
        RawTechnology.braking_force_5,
        RawTechnology.braking_force_6,
        RawTechnology.braking_force_7,
    ],
    "progressive-uranium": [
        RawTechnology.uranium_mining,
        RawTechnology.uranium_processing,
        RawTechnology.nuclear_power,
        RawTechnology.uranium_ammo,
        RawTechnology.kovarex_enrichment_process,
        RawTechnology.nuclear_fuel_reprocessing,
    ],

    "progressive-space": [
        RawTechnology.concrete,
        RawTechnology.low_density_structure,
        RawTechnology.rocket_fuel,
        RawTechnology.rocket_silo,
        RawTechnology.space_platform,
        RawTechnology.space_science_pack,
        RawTechnology.space_platform_thruster,
        RawTechnology.advanced_asteroid_processing,
        RawTechnology.asteroid_reprocessing,
        RawTechnology.asteroid_productivity, # infinite
    ],
    "progressive-vulcanus": [
        RawTechnology.planet_discovery_vulcanus,
        RawTechnology.tungsten_carbide,
        RawTechnology.foundry,
        RawTechnology.big_mining_drill,
        RawTechnology.tungsten_steel,
        RawTechnology.metallurgic_science_pack,
        RawTechnology.calcite_processing,
        RawTechnology.cliff_explosives,
        RawTechnology.low_density_structure_productivity, # infinite
    ],
    "progressive-gleba": [
        RawTechnology.landfill,
        RawTechnology.planet_discovery_gleba,
        RawTechnology.yumako,
        RawTechnology.biochamber,
        RawTechnology.jellynut,
        RawTechnology.bioflux,
        RawTechnology.agriculture,
        RawTechnology.agricultural_science_pack,
        RawTechnology.bacteria_cultivation,
        RawTechnology.bioflux_processing,
        RawTechnology.artificial_soil,
        RawTechnology.overgrowth_soil,
        RawTechnology.rocket_fuel_productivity, # infinite
    ],
    "progressive-fulgora": [
        RawTechnology.electric_energy_accumulators,
        RawTechnology.planet_discovery_fulgora,
        RawTechnology.recycling,
        RawTechnology.holmium_processing,
        RawTechnology.electromagnetic_plant,
        RawTechnology.electromagnetic_science_pack,
        RawTechnology.lightning_collector,
        RawTechnology.scrap_recycling_productivity, # infinite
    ],
    "progressive-aquilo": [
        RawTechnology.planet_discovery_aquilo,
        RawTechnology.lithium_processing,
        RawTechnology.cryogenic_plant,
        RawTechnology.cryogenic_science_pack,
        RawTechnology.rocket_part_productivity, # infinite
    ],
    "progressive-promethium": [
        RawTechnology.railgun,
        RawTechnology.promethium_science_pack,
        RawTechnology.research_productivity, # infinite
    ],

    "progressive-captivity": [
        RawTechnology.captivity,
        RawTechnology.biolab,
        RawTechnology.captive_biter_spawner,
    ],

    "progressive-military": [
        RawTechnology.military_1,
        RawTechnology.gun_turret,
        RawTechnology.stone_wall,
        RawTechnology.military_2,
        RawTechnology.military_science_pack,
        RawTechnology.weapon_shooting_speed_1,
        RawTechnology.weapon_shooting_speed_2,
        RawTechnology.weapon_shooting_speed_3,
        RawTechnology.weapon_shooting_speed_4,
        RawTechnology.weapon_shooting_speed_5,
        RawTechnology.weapon_shooting_speed_6,
    ],
    "progressive-explosives": [
        RawTechnology.explosives,
        RawTechnology.rocketry,
        RawTechnology.land_mine,
        RawTechnology.stronger_explosives_1,
        RawTechnology.stronger_explosives_2,
        RawTechnology.explosive_rocketry,
        RawTechnology.rocket_turret,
        RawTechnology.stronger_explosives_3,
        RawTechnology.stronger_explosives_4,
        RawTechnology.stronger_explosives_5,
        RawTechnology.stronger_explosives_6,
        RawTechnology.atomic_bomb,
        RawTechnology.stronger_explosives_7, # infinite
    ],

    "progressive-armor": [
        RawTechnology.heavy_armor,
        RawTechnology.modular_armor,
        RawTechnology.power_armor,
        RawTechnology.power_armor_mk2,
        RawTechnology.mech_armor,
    ],
    "progressive-portable-power": [
        RawTechnology.solar_panel_equipment,
        RawTechnology.fission_reactor_equipment,
        RawTechnology.fusion_reactor_equipment,
    ],
    "progressive-personal-battery": [
        RawTechnology.battery_equipment,
        RawTechnology.battery_mk2_equipment,
        RawTechnology.battery_mk3_equipment,
    ],
    "progressive-personal-roboport": [
        RawTechnology.personal_roboport_equipment,
        RawTechnology.personal_roboport_mk2_equipment,
    ],
    "progressive-energy-shield": [
        RawTechnology.energy_shield_equipment,
        RawTechnology.energy_shield_mk2_equipment,
    ],
    "progressive-follower-robot": [
        RawTechnology.defender,
        RawTechnology.distractor,
        RawTechnology.destroyer,
    ],

    "progressive-quality": [
        RawTechnology.epic_quality,
        RawTechnology.legendary_quality,
    ],

}

assert sum(len(v) for v in large_progressive_groups.values()) == len(set(itertools.chain.from_iterable(large_progressive_groups.values()))), "a technology is in two progressive groups"
...
def generate_everything(the_data: dict):
    ...
    # If any one recipe in a progressive chain is advancement, then every progressive item is advancement.
