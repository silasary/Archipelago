...
def run_gui():
    from .kvui import App, ContainerLayout, GridLayout, Button, Label, OldScrollBox, Widget, ApAsyncImage
    from kivy.core.window import Window
    from kivy.uix.relativelayout import RelativeLayout

    class OldLauncher(App):
        base_title: str = "Archipelago Launcher"
        container: ContainerLayout
        grid: GridLayout
        _tool_layout: Optional[OldScrollBox] = None
        _client_layout: Optional[OldScrollBox] = None
