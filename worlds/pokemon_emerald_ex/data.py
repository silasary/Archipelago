...
def _init() -> None:
    ...
    all_species: List[Tuple[str, str, int]] = [
        ...
        ("SPECIES_CHIMCHAR", "CHIMCHAR", -1),
        ("SPECIES_MONFERNO", "MONFERNO", -1),
        ("SPECIES_INFERNAPE", "INFERNAPE", -1),
        ("SPECIES_PIPLUP", "PIPLUP", -1),
        ("SPECIES_PRINPLUP", "PRINPLUP", -1),
        ("SPECIES_EMPOLEON", "EMPOLEON", -1),
        ("SPECIES_STARLY", "STARLY", -1),
        ("SPECIES_STARAVIA", "STARAVIA", -1),
        ("SPECIES_STARAPTOR", "STARAPTOR", -1),
        ("SPECIES_BIDOOF", "BIDOOF", -1),
        ("SPECIES_BIBAREL", "BIBAREL", -1),
        ("SPECIES_KRICKETOT", "KRICKETOT", -1),
        ("SPECIES_KRICKETUNE", "KRICKETUNE", -1),
        ("SPECIES_SHINX", "SHINX", -1),
        ("SPECIES_LUXIO", "LUXIO", -1),
        ("SPECIES_LUXRAY", "LUXRAY", -1),
        ("SPECIES_BUDEW", "BUDEW", -1),
        ("SPECIES_ROSERADE", "ROSERADE", -1),
        ("SPECIES_CRANIDOS", "CRANIDOS", -1),
        ("SPECIES_RAMPARDOS", "RAMPARDOS", -1),
        ("SPECIES_SHIELDON", "SHIELDON", -1),
        ("SPECIES_BASTIODON", "BASTIODON", -1),
        ("SPECIES_BURMY", "BURMY", -1),
        ("SPECIES_WORMADAM", "WORMADAM", -1),
        ("SPECIES_MOTHIM", "MOTHIM", -1),
        ("SPECIES_COMBEE", "COMBEE", -1),
        ("SPECIES_VESPIQUEN", "VESPIQUEN", -1),
        ("SPECIES_PACHIRISU", "PACHIRISU", -1),
        ("SPECIES_BUIZEL", "BUIZEL", -1),
        ("SPECIES_FLOATZEL", "FLOATZEL", -1),
        ("SPECIES_CHERUBI", "CHERUBI", -1),
        ("SPECIES_CHERRIM", "CHERRIM", -1),
        ("SPECIES_SHELLOS", "SHELLOS", -1),
        ("SPECIES_GASTRODON", "GASTRODON", -1),
        ("SPECIES_AMBIPOM", "AMBIPOM", -1),
        ("SPECIES_DRIFLOON", "DRIFLOON", -1),
        ("SPECIES_DRIFBLIM", "DRIFBLIM", -1),
        ("SPECIES_BUNEARY", "BUNEARY", -1),
        ("SPECIES_LOPUNNY", "LOPUNNY", -1),
        ("SPECIES_MISMAGIUS", "MISMAGIUS", -1),
        ("SPECIES_HONCHKROW", "HONCHKROW", -1),
        ("SPECIES_GLAMEOW", "GLAMEOW", -1),
        ("SPECIES_PURUGLY", "PURUGLY", -1),
        ("SPECIES_CHINGLING", "CHINGLING", -1),
        ("SPECIES_STUNKY", "STUNKY", -1),
        ("SPECIES_SKUNTANK", "SKUNTANK", -1),
        ("SPECIES_BRONZOR", "BRONZOR", -1),
        ("SPECIES_BRONZONG", "BRONZONG", -1),
        ("SPECIES_BONSLY", "BONSLY", -1),
        ("SPECIES_MIME_JR", "MIME_JR", -1),
        ("SPECIES_HAPPINY", "HAPPINY", -1),
        ("SPECIES_CHATOT", "CHATOT", -1),
        ("SPECIES_SPIRITOMB", "SPIRITOMB", -1),
        ("SPECIES_GIBLE", "GIBLE", -1),
        ("SPECIES_GABITE", "GABITE", -1),
        ("SPECIES_GARCHOMP", "GARCHOMP", -1),
        ("SPECIES_MUNCHLAX", "MUNCHLAX", -1),
        ("SPECIES_RIOLU", "RIOLU", -1),
        ("SPECIES_LUCARIO", "LUCARIO", -1),
        ("SPECIES_HIPPOPOTAS", "HIPPOPOTAS", -1),
        ("SPECIES_HIPPOWDON", "HIPPOWDON", -1),
        ("SPECIES_SKORUPI", "SKORUPI", -1),
        ("SPECIES_DRAPION", "DRAPION", -1),
        ("SPECIES_CROAGUNK", "CROAGUNK", -1),
        ("SPECIES_TOXICROAK", "TOXICROAK", -1),
        ("SPECIES_CARNIVINE", "CARNIVINE", -1),
        ("SPECIES_FINNEON", "FINNEON", -1),
        ("SPECIES_LUMINEON", "LUMINEON", -1),
        ("SPECIES_MANTYKE", "MANTYKE", -1),
        ("SPECIES_SNOVER", "SNOVER", -1),
        ("SPECIES_ABOMASNOW", "ABOMASNOW", -1),
        ("SPECIES_WEAVILE", "WEAVILE", -1),
        ("SPECIES_MAGNEZONE", "MAGNEZONE", -1),
        ("SPECIES_LICKILICKY", "LICKILICKY", -1),
        ("SPECIES_RHYPERIOR", "RHYPERIOR", -1),
        ("SPECIES_TANGROWTH", "TANGROWTH", -1),
        ("SPECIES_ELECTIVIRE", "ELECTIVIRE", -1),
        ("SPECIES_MAGMORTAR", "MAGMORTAR", -1),
        ("SPECIES_TOGEKISS", "TOGEKISS", -1),
        ("SPECIES_YANMEGA", "YANMEGA", -1),
        ("SPECIES_LEAFEON", "LEAFEON", -1),
        ("SPECIES_GLACEON", "GLACEON", -1),
        ("SPECIES_GLISCOR", "GLISCOR", -1),
        ("SPECIES_MAMOSWINE", "MAMOSWINE", -1),
        ("SPECIES_PORYGON_Z", "PORYGON_Z", -1),
        ("SPECIES_GALLADE", "GALLADE", -1),
        ("SPECIES_PROBOPASS", "PROBOPASS", -1),
        ("SPECIES_DUSKNOIR", "DUSKNOIR", -1),
        ("SPECIES_FROSLASS", "FROSLASS", -1),
        ("SPECIES_ROTOM", "ROTOM", -1),
        ("SPECIES_UXIE", "UXIE", -1),
        ("SPECIES_MESPRIT", "MESPRIT", -1),
        ("SPECIES_AZELF", "AZELF", -1),
        ("SPECIES_DIALGA", "DIALGA", -1),
        ("SPECIES_PALKIA", "PALKIA", -1),
        ("SPECIES_HEATRAN", "HEATRAN", -1),
        ("SPECIES_REGIGIGAS", "REGIGIGAS", -1),
        ("SPECIES_GIRATINA", "GIRATINA", -1),
        ("SPECIES_CRESSELIA", "CRESSELIA", -1),
        ("SPECIES_PHIONE", "PHIONE", -1),
        ("SPECIES_MANAPHY", "MANAPHY", -1),
        ("SPECIES_DARKRAI", "DARKRAI", -1),
        ("SPECIES_SHAYMIN", "SHAYMIN", -1),
        ("SPECIES_ARCEUS", "ARCEUS", -1),
        # Unova
        ("SPECIES_VICTINI", "VICTINI", -1),
        ("SPECIES_SNIVY", "SNIVY", -1),
        ("SPECIES_SERVINE", "SERVINE", -1),
        ("SPECIES_SERPERIOR", "SERPERIOR", -1),
        ("SPECIES_TEPIG", "TEPIG", -1),
        ("SPECIES_PIGNITE", "PIGNITE", -1),
        ("SPECIES_EMBOAR", "EMBOAR", -1),
        ("SPECIES_OSHAWOTT", "OSHAWOTT", -1),
        ("SPECIES_DEWOTT", "DEWOTT", -1),
        ("SPECIES_SAMUROTT", "SAMUROTT", -1),
        ("SPECIES_PATRAT", "PATRAT", -1),
        ("SPECIES_WATCHOG", "WATCHOG", -1),
        ("SPECIES_LILLIPUP", "LILLIPUP", -1),
        ("SPECIES_HERDIER", "HERDIER", -1),
        ("SPECIES_STOUTLAND", "STOUTLAND", -1),
        ("SPECIES_PURRLOIN", "PURRLOIN", -1),
        ("SPECIES_LIEPARD", "LIEPARD", -1),
        ("SPECIES_PANSAGE", "PANSAGE", -1),
        ("SPECIES_SIMISAGE", "SIMISAGE", -1),
        ("SPECIES_PANSEAR", "PANSEAR", -1),
        ("SPECIES_SIMISEAR", "SIMISEAR", -1),
        ("SPECIES_PANPOUR", "PANPOUR", -1),
        ("SPECIES_SIMIPOUR", "SIMIPOUR", -1),
        ("SPECIES_MUNNA", "MUNNA", -1),
        ("SPECIES_MUSHARNA", "MUSHARNA", -1),
        ("SPECIES_PIDOVE", "PIDOVE", -1),
        ("SPECIES_TRANQUILL", "TRANQUILL", -1),
        ("SPECIES_UNFEZANT", "UNFEZANT", -1),
        ("SPECIES_BLITZLE", "BLITZLE", -1),
        ("SPECIES_ZEBSTRIKA", "ZEBSTRIKA", -1),
        ("SPECIES_ROGGENROLA", "ROGGENROLA", -1),
        ("SPECIES_BOLDORE", "BOLDORE", -1),
        ("SPECIES_GIGALITH", "GIGALITH", -1),
        ("SPECIES_WOOBAT", "WOOBAT", -1),
        ("SPECIES_SWOOBAT", "SWOOBAT", -1),
        ("SPECIES_DRILBUR", "DRILBUR", -1),
        ("SPECIES_EXCADRILL", "EXCADRILL", -1),
        ("SPECIES_AUDINO", "AUDINO", -1),
        ("SPECIES_TIMBURR", "TIMBURR", -1),
        ("SPECIES_GURDURR", "GURDURR", -1),
        ("SPECIES_CONKELDURR", "CONKELDURR", -1),
        ("SPECIES_TYMPOLE", "TYMPOLE", -1),
        ("SPECIES_PALPITOAD", "PALPITOAD", -1),
        ("SPECIES_SEISMITOAD", "SEISMITOAD", -1),
        ("SPECIES_THROH", "THROH", -1),
        ("SPECIES_SAWK", "SAWK", -1),
        ("SPECIES_SEWADDLE", "SEWADDLE", -1),
        ("SPECIES_SWADLOON", "SWADLOON", -1),
        ("SPECIES_LEAVANNY", "LEAVANNY", -1),
        ("SPECIES_VENIPEDE", "VENIPEDE", -1),
        ("SPECIES_WHIRLIPEDE", "WHIRLIPEDE", -1),
        ("SPECIES_SCOLIPEDE", "SCOLIPEDE", -1),
        ("SPECIES_COTTONEE", "COTTONEE", -1),
        ("SPECIES_WHIMSICOTT", "WHIMSICOTT", -1),
        ("SPECIES_PETILIL", "PETILIL", -1),
        ("SPECIES_LILLIGANT", "LILLIGANT", -1),
        ("SPECIES_BASCULIN", "BASCULIN", -1),
        ("SPECIES_SANDILE", "SANDILE", -1),
        ("SPECIES_KROKOROK", "KROKOROK", -1),
        ("SPECIES_KROOKODILE", "KROOKODILE", -1),
        ("SPECIES_DARUMAKA", "DARUMAKA", -1),
        ("SPECIES_DARMANITAN", "DARMANITAN", -1),
        ("SPECIES_MARACTUS", "MARACTUS", -1),
        ("SPECIES_DWEBBLE", "DWEBBLE", -1),
        ("SPECIES_CRUSTLE", "CRUSTLE", -1),
        ("SPECIES_SCRAGGY", "SCRAGGY", -1),
        ("SPECIES_SCRAFTY", "SCRAFTY", -1),
        ("SPECIES_SIGILYPH", "SIGILYPH", -1),
        ("SPECIES_YAMASK", "YAMASK", -1),
        ("SPECIES_COFAGRIGUS", "COFAGRIGUS", -1),
        ("SPECIES_TIRTOUGA", "TIRTOUGA", -1),
        ("SPECIES_CARRACOSTA", "CARRACOSTA", -1),
        ("SPECIES_ARCHEN", "ARCHEN", -1),
        ("SPECIES_ARCHEOPS", "ARCHEOPS", -1),
        ("SPECIES_TRUBBISH", "TRUBBISH", -1),
        ("SPECIES_GARBODOR", "GARBODOR", -1),
        ("SPECIES_ZORUA", "ZORUA", -1),
        ("SPECIES_ZOROARK", "ZOROARK", -1),
        ("SPECIES_MINCCINO", "MINCCINO", -1),
        ("SPECIES_CINCCINO", "CINCCINO", -1),
        ("SPECIES_GOTHITA", "GOTHITA", -1),
        ("SPECIES_GOTHORITA", "GOTHORITA", -1),
        ("SPECIES_GOTHITELLE", "GOTHITELLE", -1),
        ("SPECIES_SOLOSIS", "SOLOSIS", -1),
        ("SPECIES_DUOSION", "DUOSION", -1),
        ("SPECIES_REUNICLUS", "REUNICLUS", -1),
        ("SPECIES_DUCKLETT", "DUCKLETT", -1),
        ("SPECIES_SWANNA", "SWANNA", -1),
        ("SPECIES_VANILLITE", "VANILLITE", -1),
        ("SPECIES_VANILLISH", "VANILLISH", -1),
        ("SPECIES_VANILLUXE", "VANILLUXE", -1),
        ("SPECIES_DEERLING", "DEERLING", -1),
        ("SPECIES_SAWSBUCK", "SAWSBUCK", -1),
        ("SPECIES_EMOLGA", "EMOLGA", -1),
        ("SPECIES_KARRABLAST", "KARRABLAST", -1),
        ("SPECIES_ESCAVALIER", "ESCAVALIER", -1),
        ("SPECIES_FOONGUS", "FOONGUS", -1),
        ("SPECIES_AMOONGUSS", "AMOONGUSS", -1),
        ("SPECIES_FRILLISH", "FRILLISH", -1),
        ("SPECIES_JELLICENT", "JELLICENT", -1),
        ("SPECIES_ALOMOMOLA", "ALOMOMOLA", -1),
        ("SPECIES_JOLTIK", "JOLTIK", -1),
        ("SPECIES_GALVANTULA", "GALVANTULA", -1),
        ("SPECIES_FERROSEED", "FERROSEED", -1),
        ("SPECIES_FERROTHORN", "FERROTHORN", -1),
        ("SPECIES_KLINK", "KLINK", -1),
        ("SPECIES_KLANG", "KLANG", -1),
        ("SPECIES_KLINKLANG", "KLINKLANG", -1),
        ("SPECIES_TYNAMO", "TYNAMO", -1),
        ("SPECIES_EELEKTRIK", "EELEKTRIK", -1),
        ("SPECIES_EELEKTROSS", "EELEKTROSS", -1),
        ("SPECIES_ELGYEM", "ELGYEM", -1),
        ("SPECIES_BEHEEYEM", "BEHEEYEM", -1),
        ("SPECIES_LITWICK", "LITWICK", -1),
        ("SPECIES_LAMPENT", "LAMPENT", -1),
        ("SPECIES_CHANDELURE", "CHANDELURE", -1),
        ("SPECIES_AXEW", "AXEW", -1),
        ("SPECIES_FRAXURE", "FRAXURE", -1),
        ("SPECIES_HAXORUS", "HAXORUS", -1),
        ("SPECIES_CUBCHOO", "CUBCHOO", -1),
        ("SPECIES_BEARTIC", "BEARTIC", -1),
        ("SPECIES_CRYOGONAL", "CRYOGONAL", -1),
        ("SPECIES_SHELMET", "SHELMET", -1),
        ("SPECIES_ACCELGOR", "ACCELGOR", -1),
        ("SPECIES_STUNFISK", "STUNFISK", -1),
        ("SPECIES_MIENFOO", "MIENFOO", -1),
        ("SPECIES_MIENSHAO", "MIENSHAO", -1),
        ("SPECIES_DRUDDIGON", "DRUDDIGON", -1),
        ("SPECIES_GOLETT", "GOLETT", -1),
        ("SPECIES_GOLURK", "GOLURK", -1),
        ("SPECIES_PAWNIARD", "PAWNIARD", -1),
        ("SPECIES_BISHARP", "BISHARP", -1),
        ("SPECIES_BOUFFALANT", "BOUFFALANT", -1),
        ("SPECIES_RUFFLET", "RUFFLET", -1),
        ("SPECIES_BRAVIARY", "BRAVIARY", -1),
        ("SPECIES_VULLABY", "VULLABY", -1),
        ("SPECIES_MANDIBUZZ", "MANDIBUZZ", -1),
        ("SPECIES_HEATMOR", "HEATMOR", -1),
        ("SPECIES_DURANT", "DURANT", -1),
        ("SPECIES_DEINO", "DEINO", -1),
        ("SPECIES_ZWEILOUS", "ZWEILOUS", -1),
        ("SPECIES_HYDREIGON", "HYDREIGON", -1),
        ("SPECIES_LARVESTA", "LARVESTA", -1),
        ("SPECIES_VOLCARONA", "VOLCARONA", -1),
        ("SPECIES_COBALION", "COBALION", -1),
        ("SPECIES_TERRAKION", "TERRAKION", -1),
        ("SPECIES_VIRIZION", "VIRIZION", -1),
        ("SPECIES_TORNADUS", "TORNADUS", -1),
        ("SPECIES_THUNDURUS", "THUNDURUS", -1),
        ("SPECIES_RESHIRAM", "RESHIRAM", -1),
        ("SPECIES_ZEKROM", "ZEKROM", -1),
        ("SPECIES_LANDORUS", "LANDORUS", -1),
        ("SPECIES_KYUREM", "KYUREM", -1),
        ("SPECIES_KELDEO", "KELDEO", -1),
        ("SPECIES_MELOETTA", "MELOETTA", -1),
        ("SPECIES_GENESECT", "GENESECT", -1),
        # Kalos
        ("SPECIES_CHESPIN", "CHESPIN", -1),
        ("SPECIES_QUILLADIN", "QUILLADIN", -1),
        ("SPECIES_CHESNAUGHT", "CHESNAUGHT", -1),
        ("SPECIES_FENNEKIN", "FENNEKIN", -1),
        ("SPECIES_BRAIXEN", "BRAIXEN", -1),
        ("SPECIES_DELPHOX", "DELPHOX", -1),
        ("SPECIES_FROAKIE", "FROAKIE", -1),
        ("SPECIES_FROGADIER", "FROGADIER", -1),
        ("SPECIES_GRENINJA", "GRENINJA", -1),
        ("SPECIES_BUNNELBY", "BUNNELBY", -1),
        ("SPECIES_DIGGERSBY", "DIGGERSBY", -1),
        ("SPECIES_FLETCHLING", "FLETCHLING", -1),
        ("SPECIES_FLETCHINDER", "FLETCHINDER", -1),
        ("SPECIES_TALONFLAME", "TALONFLAME", -1),
        ("SPECIES_SCATTERBUG", "SCATTERBUG", -1),
        ("SPECIES_SPEWPA", "SPEWPA", -1),
        ("SPECIES_VIVILLON", "VIVILLON", -1),
        ("SPECIES_LITLEO", "LITLEO", -1),
        ("SPECIES_PYROAR", "PYROAR", -1),
        ("SPECIES_FLABEBE", "FLABEBE", -1),
        ("SPECIES_FLOETTE", "FLOETTE", -1),
        ("SPECIES_FLORGES", "FLORGES", -1),
        ("SPECIES_SKIDDO", "SKIDDO", -1),
        ("SPECIES_GOGOAT", "GOGOAT", -1),
        ("SPECIES_PANCHAM", "PANCHAM", -1),
        ("SPECIES_PANGORO", "PANGORO", -1),
        ("SPECIES_FURFROU", "FURFROU", -1),
        ("SPECIES_ESPURR", "ESPURR", -1),
        ("SPECIES_MEOWSTIC", "MEOWSTIC", -1),
        ("SPECIES_HONEDGE", "HONEDGE", -1),
        ("SPECIES_DOUBLADE", "DOUBLADE", -1),
        ("SPECIES_AEGISLASH", "AEGISLASH", -1),
        ("SPECIES_SPRITZEE", "SPRITZEE", -1),
        ("SPECIES_AROMATISSE", "AROMATISSE", -1),
        ("SPECIES_SWIRLIX", "SWIRLIX", -1),
        ("SPECIES_SLURPUFF", "SLURPUFF", -1),
        ("SPECIES_INKAY", "INKAY", -1),
        ("SPECIES_MALAMAR", "MALAMAR", -1),
        ("SPECIES_BINACLE", "BINACLE", -1),
        ("SPECIES_BARBARACLE", "BARBARACLE", -1),
        ("SPECIES_SKRELP", "SKRELP", -1),
        ("SPECIES_DRAGALGE", "DRAGALGE", -1),
        ("SPECIES_CLAUNCHER", "CLAUNCHER", -1),
        ("SPECIES_CLAWITZER", "CLAWITZER", -1),
        ("SPECIES_HELIOPTILE", "HELIOPTILE", -1),
        ("SPECIES_HELIOLISK", "HELIOLISK", -1),
        ("SPECIES_TYRUNT", "TYRUNT", -1),
        ("SPECIES_TYRANTRUM", "TYRANTRUM", -1),
        ("SPECIES_AMAURA", "AMAURA", -1),
        ("SPECIES_AURORUS", "AURORUS", -1),
        ("SPECIES_SYLVEON", "SYLVEON", -1),
        ("SPECIES_HAWLUCHA", "HAWLUCHA", -1),
        ("SPECIES_DEDENNE", "DEDENNE", -1),
        ("SPECIES_CARBINK", "CARBINK", -1),
        ("SPECIES_GOOMY", "GOOMY", -1),
        ("SPECIES_SLIGGOO", "SLIGGOO", -1),
        ("SPECIES_GOODRA", "GOODRA", -1),
        ("SPECIES_KLEFKI", "KLEFKI", -1),
        ("SPECIES_PHANTUMP", "PHANTUMP", -1),
        ("SPECIES_TREVENANT", "TREVENANT", -1),
        ("SPECIES_PUMPKABOO", "PUMPKABOO", -1),
        ("SPECIES_GOURGEIST", "GOURGEIST", -1),
        ("SPECIES_BERGMITE", "BERGMITE", -1),
        ("SPECIES_AVALUGG", "AVALUGG", -1),
        ("SPECIES_NOIBAT", "NOIBAT", -1),
        ("SPECIES_NOIVERN", "NOIVERN", -1),
        ("SPECIES_XERNEAS", "XERNEAS", -1),
        ("SPECIES_YVELTAL", "YVELTAL", -1),
        ("SPECIES_ZYGARDE", "ZYGARDE", -1),
        ("SPECIES_DIANCIE", "DIANCIE", -1),
        ("SPECIES_HOOPA", "HOOPA", -1),
        ("SPECIES_VOLCANION", "VOLCANION", -1),
        # Alola
        ("SPECIES_ROWLET", "ROWLET", -1),
        ("SPECIES_DARTRIX", "DARTRIX", -1),
        ("SPECIES_DECIDUEYE", "DECIDUEYE", -1),
        ("SPECIES_LITTEN", "LITTEN", -1),
        ("SPECIES_TORRACAT", "TORRACAT", -1),
        ("SPECIES_INCINEROAR", "INCINEROAR", -1),
        ("SPECIES_POPPLIO", "POPPLIO", -1),
        ("SPECIES_BRIONNE", "BRIONNE", -1),
        ("SPECIES_PRIMARINA", "PRIMARINA", -1),
        ("SPECIES_PIKIPEK", "PIKIPEK", -1),
        ("SPECIES_TRUMBEAK", "TRUMBEAK", -1),
        ("SPECIES_TOUCANNON", "TOUCANNON", -1),
        ("SPECIES_YUNGOOS", "YUNGOOS", -1),
        ("SPECIES_GUMSHOOS", "GUMSHOOS", -1),
        ("SPECIES_GRUBBIN", "GRUBBIN", -1),
        ("SPECIES_CHARJABUG", "CHARJABUG", -1),
        ("SPECIES_VIKAVOLT", "VIKAVOLT", -1),
        ("SPECIES_CRABRAWLER", "CRABRAWLER", -1),
        ("SPECIES_CRABOMINABLE", "CRABOMINABLE", -1),
        ("SPECIES_ORICORIO", "ORICORIO", -1),
        ("SPECIES_CUTIEFLY", "CUTIEFLY", -1),
        ("SPECIES_RIBOMBEE", "RIBOMBEE", -1),
        ("SPECIES_ROCKRUFF", "ROCKRUFF", -1),
        ("SPECIES_LYCANROC", "LYCANROC", -1),
        ("SPECIES_WISHIWASHI", "WISHIWASHI", -1),
        ("SPECIES_MAREANIE", "MAREANIE", -1),
        ("SPECIES_TOXAPEX", "TOXAPEX", -1),
        ("SPECIES_MUDBRAY", "MUDBRAY", -1),
        ("SPECIES_MUDSDALE", "MUDSDALE", -1),
        ("SPECIES_DEWPIDER", "DEWPIDER", -1),
        ("SPECIES_ARAQUANID", "ARAQUANID", -1),
        ("SPECIES_FOMANTIS", "FOMANTIS", -1),
        ("SPECIES_LURANTIS", "LURANTIS", -1),
        ("SPECIES_MORELULL", "MORELULL", -1),
        ("SPECIES_SHIINOTIC", "SHIINOTIC", -1),
        ("SPECIES_SALANDIT", "SALANDIT", -1),
        ("SPECIES_SALAZZLE", "SALAZZLE", -1),
        ("SPECIES_STUFFUL", "STUFFUL", -1),
        ("SPECIES_BEWEAR", "BEWEAR", -1),
        ("SPECIES_BOUNSWEET", "BOUNSWEET", -1),
        ("SPECIES_STEENEE", "STEENEE", -1),
        ("SPECIES_TSAREENA", "TSAREENA", -1),
        ("SPECIES_COMFEY", "COMFEY", -1),
        ("SPECIES_ORANGURU", "ORANGURU", -1),
        ("SPECIES_PASSIMIAN", "PASSIMIAN", -1),
        ("SPECIES_WIMPOD", "WIMPOD", -1),
        ("SPECIES_GOLISOPOD", "GOLISOPOD", -1),
        ("SPECIES_SANDYGAST", "SANDYGAST", -1),
        ("SPECIES_PALOSSAND", "PALOSSAND", -1),
        ("SPECIES_PYUKUMUKU", "PYUKUMUKU", -1),
        ("SPECIES_TYPE_NULL", "TYPE_NULL", -1),
        ("SPECIES_SILVALLY", "SILVALLY", -1),
        ("SPECIES_MINIOR", "MINIOR", -1),
        ("SPECIES_KOMALA", "KOMALA", -1),
        ("SPECIES_TURTONATOR", "TURTONATOR", -1),
        ("SPECIES_TOGEDEMARU", "TOGEDEMARU", -1),
        ("SPECIES_MIMIKYU", "MIMIKYU", -1),
        ("SPECIES_BRUXISH", "BRUXISH", -1),
        ("SPECIES_DRAMPA", "DRAMPA", -1),
        ("SPECIES_DHELMISE", "DHELMISE", -1),
        ("SPECIES_JANGMO_O", "JANGMO_O", -1),
        ("SPECIES_HAKAMO_O", "HAKAMO_O", -1),
        ("SPECIES_KOMMO_O", "KOMMO_O", -1),
        ("SPECIES_TAPU_KOKO", "TAPU_KOKO", -1),
        ("SPECIES_TAPU_LELE", "TAPU_LELE", -1),
        ("SPECIES_TAPU_BULU", "TAPU_BULU", -1),
        ("SPECIES_TAPU_FINI", "TAPU_FINI", -1),
        ("SPECIES_COSMOG", "COSMOG", -1),
        ("SPECIES_COSMOEM", "COSMOEM", -1),
        ("SPECIES_SOLGALEO", "SOLGALEO", -1),
        ("SPECIES_LUNALA", "LUNALA", -1),
        ("SPECIES_NIHILEGO", "NIHILEGO", -1),
        ("SPECIES_BUZZWOLE", "BUZZWOLE", -1),
        ("SPECIES_PHEROMOSA", "PHEROMOSA", -1),
        ("SPECIES_XURKITREE", "XURKITREE", -1),
        ("SPECIES_CELESTEELA", "CELESTEELA", -1),
        ("SPECIES_KARTANA", "KARTANA", -1),
        ("SPECIES_GUZZLORD", "GUZZLORD", -1),
        ("SPECIES_NECROZMA", "NECROZMA", -1),
        ("SPECIES_MAGEARNA", "MAGEARNA", -1),
        ("SPECIES_MARSHADOW", "MARSHADOW", -1),
        ("SPECIES_POIPOLE", "POIPOLE", -1),
        ("SPECIES_NAGANADEL", "NAGANADEL", -1),
        ("SPECIES_STAKATAKA", "STAKATAKA", -1),
        ("SPECIES_BLACEPHALON", "BLACEPHALON", -1),
        ("SPECIES_ZERAORA", "ZERAORA", -1),
        # Unknown
        ("SPECIES_MELTAN", "MELTAN", -1),
        ("SPECIES_MELMETAL", "MELMETAL", -1),
        # Galar
        ("SPECIES_GROOKEY", "GROOKEY", -1),
        ("SPECIES_THWACKEY", "THWACKEY", -1),
        ("SPECIES_RILLABOOM", "RILLABOOM", -1),
        ("SPECIES_SCORBUNNY", "SCORBUNNY", -1),
        ("SPECIES_RABOOT", "RABOOT", -1),
        ("SPECIES_CINDERACE", "CINDERACE", -1),
        ("SPECIES_SOBBLE", "SOBBLE", -1),
        ("SPECIES_DRIZZILE", "DRIZZILE", -1),
        ("SPECIES_INTELEON", "INTELEON", -1),
        ("SPECIES_SKWOVET", "SKWOVET", -1),
        ("SPECIES_GREEDENT", "GREEDENT", -1),
        ("SPECIES_ROOKIDEE", "ROOKIDEE", -1),
        ("SPECIES_CORVISQUIRE", "CORVISQUIRE", -1),
        ("SPECIES_CORVIKNIGHT", "CORVIKNIGHT", -1),
        ("SPECIES_BLIPBUG", "BLIPBUG", -1),
        ("SPECIES_DOTTLER", "DOTTLER", -1),
        ("SPECIES_ORBEETLE", "ORBEETLE", -1),
        ("SPECIES_NICKIT", "NICKIT", -1),
        ("SPECIES_THIEVUL", "THIEVUL", -1),
        ("SPECIES_GOSSIFLEUR", "GOSSIFLEUR", -1),
        ("SPECIES_ELDEGOSS", "ELDEGOSS", -1),
        ("SPECIES_WOOLOO", "WOOLOO", -1),
        ("SPECIES_DUBWOOL", "DUBWOOL", -1),
        ("SPECIES_CHEWTLE", "CHEWTLE", -1),
        ("SPECIES_DREDNAW", "DREDNAW", -1),
        ("SPECIES_YAMPER", "YAMPER", -1),
        ("SPECIES_BOLTUND", "BOLTUND", -1),
        ("SPECIES_ROLYCOLY", "ROLYCOLY", -1),
        ("SPECIES_CARKOL", "CARKOL", -1),
        ("SPECIES_COALOSSAL", "COALOSSAL", -1),
        ("SPECIES_APPLIN", "APPLIN", -1),
        ("SPECIES_FLAPPLE", "FLAPPLE", -1),
        ("SPECIES_APPLETUN", "APPLETUN", -1),
        ("SPECIES_SILICOBRA", "SILICOBRA", -1),
        ("SPECIES_SANDACONDA", "SANDACONDA", -1),
        ("SPECIES_CRAMORANT", "CRAMORANT", -1),
        ("SPECIES_ARROKUDA", "ARROKUDA", -1),
        ("SPECIES_BARRASKEWDA", "BARRASKEWDA", -1),
        ("SPECIES_TOXEL", "TOXEL", -1),
        ("SPECIES_TOXTRICITY", "TOXTRICITY", -1),
        ("SPECIES_SIZZLIPEDE", "SIZZLIPEDE", -1),
        ("SPECIES_CENTISKORCH", "CENTISKORCH", -1),
        ("SPECIES_CLOBBOPUS", "CLOBBOPUS", -1),
        ("SPECIES_GRAPPLOCT", "GRAPPLOCT", -1),
        ("SPECIES_SINISTEA", "SINISTEA", -1),
        ("SPECIES_POLTEAGEIST", "POLTEAGEIST", -1),
        ("SPECIES_HATENNA", "HATENNA", -1),
        ("SPECIES_HATTREM", "HATTREM", -1),
        ("SPECIES_HATTERENE", "HATTERENE", -1),
        ("SPECIES_IMPIDIMP", "IMPIDIMP", -1),
        ("SPECIES_MORGREM", "MORGREM", -1),
        ("SPECIES_GRIMMSNARL", "GRIMMSNARL", -1),
        ("SPECIES_OBSTAGOON", "OBSTAGOON", -1),
        ("SPECIES_PERRSERKER", "PERRSERKER", -1),
        ("SPECIES_CURSOLA", "CURSOLA", -1),
        ("SPECIES_SIRFETCHD", "SIRFETCHD", -1),
        ("SPECIES_MR_RIME", "MR_RIME", -1),
        ("SPECIES_RUNERIGUS", "RUNERIGUS", -1),
        ("SPECIES_MILCERY", "MILCERY", -1),
        ("SPECIES_ALCREMIE", "ALCREMIE", -1),
        ("SPECIES_FALINKS", "FALINKS", -1),
        ("SPECIES_PINCURCHIN", "PINCURCHIN", -1),
        ("SPECIES_SNOM", "SNOM", -1),
        ("SPECIES_FROSMOTH", "FROSMOTH", -1),
        ("SPECIES_STONJOURNER", "STONJOURNER", -1),
        ("SPECIES_EISCUE", "EISCUE", -1),
        ("SPECIES_INDEEDEE", "INDEEDEE", -1),
        ("SPECIES_MORPEKO", "MORPEKO", -1),
        ("SPECIES_CUFANT", "CUFANT", -1),
        ("SPECIES_COPPERAJAH", "COPPERAJAH", -1),
        ("SPECIES_DRACOZOLT", "DRACOZOLT", -1),
        ("SPECIES_ARCTOZOLT", "ARCTOZOLT", -1),
        ("SPECIES_DRACOVISH", "DRACOVISH", -1),
        ("SPECIES_ARCTOVISH", "ARCTOVISH", -1),
        ("SPECIES_DURALUDON", "DURALUDON", -1),
        ("SPECIES_DREEPY", "DREEPY", -1),
        ("SPECIES_DRAKLOAK", "DRAKLOAK", -1),
        ("SPECIES_DRAGAPULT", "DRAGAPULT", -1),
        ("SPECIES_ZACIAN", "ZACIAN", -1),
        ("SPECIES_ZAMAZENTA", "ZAMAZENTA", -1),
        ("SPECIES_ETERNATUS", "ETERNATUS", -1),
        ("SPECIES_KUBFU", "KUBFU", -1),
        ("SPECIES_URSHIFU", "URSHIFU", -1),
        ("SPECIES_ZARUDE", "ZARUDE", -1),
        ("SPECIES_REGIELEKI", "REGIELEKI", -1),
        ("SPECIES_REGIDRAGO", "REGIDRAGO", -1),
        ("SPECIES_GLASTRIER", "GLASTRIER", -1),
        ("SPECIES_SPECTRIER", "SPECTRIER", -1),
        ("SPECIES_CALYREX", "CALYREX", -1),
        ("SPECIES_WYRDEER", "WYRDEER", -1),
        ("SPECIES_KLEAVOR", "KLEAVOR", -1),
        ("SPECIES_URSALUNA", "URSALUNA", -1),
        ("SPECIES_BASCULEGION", "BASCULEGION", -1),
        ("SPECIES_SNEASLER", "SNEASLER", -1),
        ("SPECIES_OVERQWIL", "OVERQWIL", -1),
        ("SPECIES_ENAMORUS", "ENAMORUS", -1),
        # Paldea
        ("SPECIES_SPRIGATITO", "SPRIGATITO", -1),
        ("SPECIES_FLORAGATO", "FLORAGATO", -1),
        ("SPECIES_MEOWSCARADA", "MEOWSCARADA", -1),
        ("SPECIES_FUECOCO", "FUECOCO", -1),
        ("SPECIES_CROCALOR", "CROCALOR", -1),
        ("SPECIES_SKELEDIRGE", "SKELEDIRGE", -1),
        ("SPECIES_QUAXLY", "QUAXLY", -1),
        ("SPECIES_QUAXWELL", "QUAXWELL", -1),
        ("SPECIES_QUAQUAVAL", "QUAQUAVAL", -1),
        ("SPECIES_LECHONK", "LECHONK", -1),
        ("SPECIES_OINKOLOGNE", "OINKOLOGNE", -1),
        ("SPECIES_TAROUNTULA", "TAROUNTULA", -1),
        ("SPECIES_SPIDOPS", "SPIDOPS", -1),
        ("SPECIES_NYMBLE", "NYMBLE", -1),
        ("SPECIES_LOKIX", "LOKIX", -1),
        ("SPECIES_PAWMI", "PAWMI", -1),
        ("SPECIES_PAWMO", "PAWMO", -1),
        ("SPECIES_PAWMOT", "PAWMOT", -1),
        ("SPECIES_TANDEMAUS", "TANDEMAUS", -1),
        ("SPECIES_MAUSHOLD", "MAUSHOLD", -1),
        ("SPECIES_FIDOUGH", "FIDOUGH", -1),
        ("SPECIES_DACHSBUN", "DACHSBUN", -1),
        ("SPECIES_SMOLIV", "SMOLIV", -1),
        ("SPECIES_DOLLIV", "DOLLIV", -1),
        ("SPECIES_ARBOLIVA", "ARBOLIVA", -1),
        ("SPECIES_SQUAWKABILLY", "SQUAWKABILLY", -1),
        ("SPECIES_NACLI", "NACLI", -1),
        ("SPECIES_NACLSTACK", "NACLSTACK", -1),
        ("SPECIES_GARGANACL", "GARGANACL", -1),
        ("SPECIES_CHARCADET", "CHARCADET", -1),
        ("SPECIES_ARMAROUGE", "ARMAROUGE", -1),
        ("SPECIES_CERULEDGE", "CERULEDGE", -1),
        ("SPECIES_TADBULB", "TADBULB", -1),
        ("SPECIES_BELLIBOLT", "BELLIBOLT", -1),
        ("SPECIES_WATTREL", "WATTREL", -1),
        ("SPECIES_KILOWATTREL", "KILOWATTREL", -1),
        ("SPECIES_MASCHIFF", "MASCHIFF", -1),
        ("SPECIES_MABOSSTIFF", "MABOSSTIFF", -1),
        ("SPECIES_SHROODLE", "SHROODLE", -1),
        ("SPECIES_GRAFAIAI", "GRAFAIAI", -1),
        ("SPECIES_BRAMBLIN", "BRAMBLIN", -1),
        ("SPECIES_BRAMBLEGHAST", "BRAMBLEGHAST", -1),
        ("SPECIES_TOEDSCOOL", "TOEDSCOOL", -1),
        ("SPECIES_TOEDSCRUEL", "TOEDSCRUEL", -1),
        ("SPECIES_KLAWF", "KLAWF", -1),
        ("SPECIES_CAPSAKID", "CAPSAKID", -1),
        ("SPECIES_SCOVILLAIN", "SCOVILLAIN", -1),
        ("SPECIES_RELLOR", "RELLOR", -1),
        ("SPECIES_RABSCA", "RABSCA", -1),
        ("SPECIES_FLITTLE", "FLITTLE", -1),
        ("SPECIES_ESPATHRA", "ESPATHRA", -1),
        ("SPECIES_TINKATINK", "TINKATINK", -1),
        ("SPECIES_TINKATUFF", "TINKATUFF", -1),
        ("SPECIES_TINKATON", "TINKATON", -1),
        ("SPECIES_WIGLETT", "WIGLETT", -1),
        ("SPECIES_WUGTRIO", "WUGTRIO", -1),
        ("SPECIES_BOMBIRDIER", "BOMBIRDIER", -1),
        ("SPECIES_FINIZEN", "FINIZEN", -1),
        ("SPECIES_PALAFIN", "PALAFIN", -1),
        ("SPECIES_VAROOM", "VAROOM", -1),
        ("SPECIES_REVAVROOM", "REVAVROOM", -1),
        ("SPECIES_CYCLIZAR", "CYCLIZAR", -1),
        ("SPECIES_ORTHWORM", "ORTHWORM", -1),
        ("SPECIES_GLIMMET", "GLIMMET", -1),
        ("SPECIES_GLIMMORA", "GLIMMORA", -1),
        ("SPECIES_GREAVARD", "GREAVARD", -1),
        ("SPECIES_HOUNDSTONE", "HOUNDSTONE", -1),
        ("SPECIES_FLAMIGO", "FLAMIGO", -1),
        ("SPECIES_CETODDLE", "CETODDLE", -1),
        ("SPECIES_CETITAN", "CETITAN", -1),
        ("SPECIES_VELUZA", "VELUZA", -1),
        ("SPECIES_DONDOZO", "DONDOZO", -1),
        ("SPECIES_TATSUGIRI", "TATSUGIRI", -1),
        ("SPECIES_ANNIHILAPE", "ANNIHILAPE", -1),
        ("SPECIES_CLODSIRE", "CLODSIRE", -1),
        ("SPECIES_FARIGIRAF", "FARIGIRAF", -1),
        ("SPECIES_DUDUNSPARCE", "DUDUNSPARCE", -1),
        ("SPECIES_KINGAMBIT", "KINGAMBIT", -1),
        ("SPECIES_GREAT_TUSK", "GREAT_TUSK", -1),
        ("SPECIES_SCREAM_TAIL", "SCREAM_TAIL", -1),
        ("SPECIES_BRUTE_BONNET", "BRUTE_BONNET", -1),
        ("SPECIES_FLUTTER_MANE", "FLUTTER_MANE", -1),
        ("SPECIES_SLITHER_WING", "SLITHER_WING", -1),
        ("SPECIES_SANDY_SHOCKS", "SANDY_SHOCKS", -1),
        ("SPECIES_IRON_TREADS", "IRON_TREADS", -1),
        ("SPECIES_IRON_BUNDLE", "IRON_BUNDLE", -1),
        ("SPECIES_IRON_HANDS", "IRON_HANDS", -1),
        ("SPECIES_IRON_JUGULIS", "IRON_JUGULIS", -1),
        ("SPECIES_IRON_MOTH", "IRON_MOTH", -1),
        ("SPECIES_IRON_THORNS", "IRON_THORNS", -1),
        ("SPECIES_FRIGIBAX", "FRIGIBAX", -1),
        ("SPECIES_ARCTIBAX", "ARCTIBAX", -1),
        ("SPECIES_BAXCALIBUR", "BAXCALIBUR", -1),
        ("SPECIES_GIMMIGHOUL", "GIMMIGHOUL", -1),
        ("SPECIES_GHOLDENGO", "GHOLDENGO", -1),
        ("SPECIES_WO_CHIEN", "WO_CHIEN", -1),
        ("SPECIES_CHIEN_PAO", "CHIEN_PAO", -1),
        ("SPECIES_TING_LU", "TING_LU", -1),
        ("SPECIES_CHI_YU", "CHI_YU", -1),
        ("SPECIES_ROARING_MOON", "ROARING_MOON", -1),
        ("SPECIES_IRON_VALIANT", "IRON_VALIANT", -1),
        ("SPECIES_KORAIDON", "KORAIDON", -1),
        ("SPECIES_MIRAIDON", "MIRAIDON", -1),
        ("SPECIES_WALKING_WAKE", "WALKING_WAKE", -1),
        ("SPECIES_IRON_LEAVES", "IRON_LEAVES", -1),
        ("SPECIES_DIPPLIN", "DIPPLIN", -1),
        ("SPECIES_POLTCHAGEIST", "POLTCHAGEIST", -1),
        ("SPECIES_SINISTCHA", "SINISTCHA", -1),
        ("SPECIES_OKIDOGI", "OKIDOGI", -1),
        ("SPECIES_MUNKIDORI", "MUNKIDORI", -1),
        ("SPECIES_FEZANDIPITI", "FEZANDIPITI", -1),
        ("SPECIES_OGERPON", "OGERPON", -1),
        ("SPECIES_ARCHALUDON", "ARCHALUDON", -1),
        ("SPECIES_HYDRAPPLE", "HYDRAPPLE", -1),
        ("SPECIES_GOUGING_FIRE", "GOUGING_FIRE", -1),
        ("SPECIES_RAGING_BOLT", "RAGING_BOLT", -1),
        ("SPECIES_IRON_BOULDER", "IRON_BOULDER", -1),
        ("SPECIES_IRON_CROWN", "IRON_CROWN", -1),
        ("SPECIES_TERAPAGOS", "TERAPAGOS", -1),
        ("SPECIES_PECHARUNT", "PECHARUNT", -1),
    ]
