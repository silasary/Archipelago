...
all_species: list[tuple[str, str, int]] = [
    ...
    ("SPECIES_PORYGON_Z", "Porygon_Z", 474),
    ...
    ("SPECIES_TYPE_NULL", "Type_Null", 772),
    ...
    ("SPECIES_JANGMO_O", "Jangmo_O", 782),
    ("SPECIES_HAKAMO_O", "Hakamo_O", 783),
    ("SPECIES_KOMMO_O", "Kommo_O", 784),
    ("SPECIES_TAPU_KOKO", "Tapu_Koko", 785),
    ("SPECIES_TAPU_LELE", "Tapu_Lele", 786),
    ("SPECIES_TAPU_BULU", "Tapu_Bulu", 787),
    ("SPECIES_TAPU_FINI", "Tapu_Fini", 788),
    ...
    ("SPECIES_GREAT_TUSK", "Great_Tusk", 984),
    ("SPECIES_SCREAM_TAIL", "Scream_Tail", 985),
    ("SPECIES_BRUTE_BONNET", "Brute_Bonnet", 986),
    ("SPECIES_FLUTTER_MANE", "Flutter_Mane", 987),
    ("SPECIES_SLITHER_WING", "Slither_Wing", 988),
    ("SPECIES_SANDY_SHOCKS", "Sandy_Shocks", 989),
    ("SPECIES_IRON_TREADS", "Iron_Treads", 990),
    ("SPECIES_IRON_BUNDLE", "Iron_Bundle", 991),
    ("SPECIES_IRON_HANDS", "Iron_Hands", 992),
    ("SPECIES_IRON_JUGULIS", "Iron_Jugulis", 993),
    ("SPECIES_IRON_MOTH", "Iron_Moth", 994),
    ("SPECIES_IRON_THORNS", "Iron_Thorns", 995),
    ...
    ("SPECIES_WO_CHIEN", "Wo_Chien", 1001),
    ("SPECIES_CHIEN_PAO", "Chien_Pao", 1002),
    ("SPECIES_TING_LU", "Ting_Lu", 1003),
    ("SPECIES_CHI_YU", "Chi_Yu", 1004),
    ("SPECIES_ROARING_MOON", "Roaring_Moon", 1005),
    ("SPECIES_IRON_VALIANT", "Iron_Valiant", 1006),
    ("SPECIES_KORAIDON", "Koraidon", 1007),
    ("SPECIES_MIRAIDON", "Miraidon", 1008),
    ("SPECIES_WALKING_WAKE", "Walking_Wake", 1009),
    ("SPECIES_IRON_LEAVES", "Iron_Leaves", 1010),
    ...
    ("SPECIES_GOUGING_FIRE", "Gouging_Fire", 1020),
    ("SPECIES_RAGING_BOLT", "Raging_Bolt", 1021),
    ("SPECIES_IRON_BOULDER", "Iron_Boulder", 1022),
    ("SPECIES_IRON_CROWN", "Iron_Crown", 1023),
